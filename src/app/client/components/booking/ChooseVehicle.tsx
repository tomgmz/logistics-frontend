      ...
      <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 lg:flex-1 lg:min-h-0">
        ...
        >
          <div className="px-4 sm:px-5 lg:px-6 pt-4 sm:pt-5 pb-1 shrink-0">
            ...
            <p className="font-body booking-text text-[var(--color-muted)] text-xs sm:text-sm sm:pl-5">
          ...
          <div className="flex-1 lg:min-h-0 lg:overflow-auto flex flex-col px-3 sm:px-4 lg:px-5 pb-4 sm:pb-5 gap-3 sm:gap-4">
            ...
            <div className="relative flex items-center gap-2">
              ...
              <div className="flex-1 relative overflow-hidden rounded-xl bg-gradient-to-b from-[#1e1e1e] to-[#111111] min-h-[160px] sm:min-h-[200px] lg:min-h-[240px]">
...
function SpecRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-center justify-between px-0 py-2 sm:py-2.5">
      <span className="font-body booking-text text-[var(--color-muted)] uppercase tracking-wider">
        {label}
      </span>
