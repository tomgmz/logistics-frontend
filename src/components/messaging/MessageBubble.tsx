    ...
    >
      ...
      <div className={`flex flex-col gap-1 ${isMine ? 'items-end' : 'items-start'}`}>
        {!isMine && showSenderName && sender && (
          <span className="ff-body text-[11px] text-[var(--color-cyan)] px-1">
        ...
        <div
          className={`
            px-3.5 py-2.5 ff-body text-[13px] leading-relaxed break-words
            ${isMine
        ...
        <div className={`flex items-center gap-1 px-1 ${isMine ? 'flex-row-reverse' : ''}`}>
          <span className="ff-body text-[10px] text-white/25">
