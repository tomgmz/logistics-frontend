...
//           className="w-full mt-2 py-4 font-bold tracking-[0.2em] uppercase text-[0.82rem]
...
//               className="fixed glass top-0 right-0 bottom-0 z-[90] flex flex-col \
//               w-full sm:w-[480px] lg:w-[42vw] max-w-[560px] border-3 border-black"
